...
import StoryMenuState.StoryMenuState;
			...
			switch (daSelected)
			{
				...
				case "Exit to menu":
					...
					if (PlayState.isStoryMode) {
						...
						storyState.currentSelected = PlayState.SONG.song.toLowerCase();
						if(PlayState.SONG.song.toLowerCase() == 'icicle bay') {
							storyState.currentSelected = 'oceanfalls';
						}
