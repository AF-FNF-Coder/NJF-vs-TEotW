...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		new OptionCategory("Gameplay", [
			new YouSuckOption('Change how much health you lose when you miss a note. Also enables ghost tapping. \nSecret Text hehe'),
		...
		new OptionCategory("Misc", [
			new TwitchSafetyOption('Disable viewing of videos that can get you banned from Twitch.'),
		...
		new OptionCategory("Saves and Data", [
			...
			#end
			new ResetViewedClipsOption("Reset your viewed clips. This is irreversible!"),
