...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		// AF Enjoyer: This is what adds the text + icon to the freeplay menu
	...
	function changeDiff(change:Int = 0)
	{
		...
		#end
		// AF Enjoyer: These songs will only have 1 difficulty, but imma comment this for now
		//if(songs[curSelected].songName.toLowerCase().startsWith("they") || songs[curSelected].songName.toLowerCase() == 'you win') {
		//	diffCalcText.text = 'RATING: ${DiffCalc.CalculateDiff(songData.get(songs[curSelected].songName)[0])}';
		//	diffText.text = CoolUtil.difficultyFromInt(0).toUpperCase();
		//} else {
	...
	function changeSelection(change:Int = 0)
	{
		...
		// AF Enjoyer: These songs will only have 1 difficulty
		//if(songs[curSelected].songName.toLowerCase().startsWith("they") || songs[curSelected].songName.toLowerCase() == 'you win') {
		//	diffCalcText.text = 'RATING: ${DiffCalc.CalculateDiff(songData.get(songs[curSelected].songName)[0])}';
		//} else {
			diffCalcText.text = 'RATING: ${DiffCalc.CalculateDiff(songData.get(songs[curSelected].songName)[curDifficulty])}';
